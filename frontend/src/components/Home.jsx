...
//           Your data is encrypted using AES-256, and we never store your master password.
//         </p>
//       </div>
//     </div>
//   );
...
//           <FaShieldAlt className="text-blue-400 text-4xl inline-block" />
//         </div>
...
//               activeClass = "ring-2 ring-offset-2 ring-offset-gray-900 ring-blue-500 transform scale-105";
//             }
...
//               >
//                 <div className="flex items-center mb-3">
//                   <div className={`rounded-full p-2 mr-3 ${statusColors} ${animationStep === index ? 'animate-pulse' : ''}`}>
//                     {step.icon}
//                   </div>
//                   <div className="font-bold">{step.title}</div>
//                 </div>
...
//                     {/* <FaArrowRight
//                       className={`
//                         ${step.status === 'disabled' ? 'text-gray-700' : 'text-blue-400'}
...
//             <div
//               key={index}
//               className="bg-gray-900 hover:bg-gray-800 transition-colors p-6 rounded-xl shadow-lg border border-gray-700 hover:border-blue-500 transform transition-transform hover:scale-[1.02]"
//             >
//               <div className="flex items-center mb-4">
//                 <div className="p-3 bg-gray-800 rounded-full mr-4">
//                   {feature.icon}
...
//       {/* Security Visualization with Animation */}
//       <div className="bg-gray-900 rounded-xl p-6 mb-8">
//         <h2 className="text-2xl font-bold mb-6 flex items-center">
//           <FaFingerprint className={`text-blue-400 mr-3 ${animationStep === 0 ? 'animate-spin' : ''}`} />
//           Security Visualization
//         </h2>
//         <div className="flex flex-wrap justify-center">
//           <div className="max-w-lg w-full">
//             <div className="relative p-4">
//               {/* Visual representation of encryption process with animation */}
//               <div className="flex items-center justify-between mb-8 relative">
//                 {/* Animation dot that moves through the workflow */}
//                 <div
//                   className={`absolute w-4 h-4 bg-blue-500 rounded-full transition-all duration-1000 ease-in-out z-20`}
//                   style={{
//                     left: animationStep === 0 ? '12%' :
//                            animationStep === 1 ? '50%' :
//                            animationStep === 2 ? '88%' : '12%',
//                     top: '50%',
...
//                 {/* Connected line */}
//                 <div className="absolute h-1 bg-gray-700 left-[12%] right-[12%] top-1/2 transform -translate-y-1/2"></div>

//                 <div className={`relative text-center p-3 bg-gray-800 border-2 ${animationStep === 0 ? 'border-blue-500 animate-pulse' : 'border-transparent'} rounded-lg w-1/4 z-10 transition-all duration-300`}>
//                   <FaKey className={`text-yellow-500 mx-auto ${animationStep === 0 ? 'animate-bounce' : ''}`} />
//                   <div className="text-xs mt-2">Master Password</div>
//                 </div>
